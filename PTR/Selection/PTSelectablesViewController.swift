...
class PTSelectablesViewController: PTViewController {
    
    var dataSource: PTSelectablesDataSource!
    
    var firstAppear = true
    
    var selectionTitle: String? {
        didSet {
            self.headerView?.titleLabel?.text = selectionTitle
        }
    }
    ...
    var selectionDetails: String? {
        didSet {
            self.headerView?.subtitleLabel?.text = selectionDetails
        }
    }
    ...
    func setupHeaderView() {
        ...
        headerView.titleLabel.text = selectionTitle
        headerView.subtitleLabel.text = selectionDetails
